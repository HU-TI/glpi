 ...
 <div id="pad-wrapper" >	
	<div id="charts" class="row-fluid chart"> 
		<div id="head" class="row-fluid">
			...
			<div id="titulo"> <?php echo __('Tickets across time','dashboard') ;  ?>  
		...
		<div id="grafday" class="row-fluid" style="margin-top: 30px;">
			<?php include ("./inc/grafbar_ticket_day.inc.php"); ?>	
		</div>
		
		<div id="grafmonth" class="row-fluid" style="margin-top: 35px;">
