...
echo '<div id="entidade" class="col-md-12 row-fluid">';
...
<div id="graf3" class="span12" >
	<?php  include ("./inc/grafbar_cat_user.inc.php");  ?>
</div>

<div id="grafcat_tec" class="span12" style="height: 450px; margin-top: 240px; margin-left: -5px;">
