...
<div id="graf_user" class="span12" style="height: 450px; margin-top:30px; margin-bottom:120px; margin-left: -5px;">
	<?php  include ("./inc/grafbar_user_grupo.inc.php"); ?>
</div>

<div id="graf_time1" class="span12" style="height: 450px; margin-top:30px; margin-left: -5px;">
