...
<script type="text/javascript" >
	...
	<div id="graf_time1" class="span12" style="height: 450px; margin-top:30px; margin-bottom:0px; margin-left: -5px;">
		<?php  include ("./inc/grafpie_time_tecnico.inc.php"); ?>
	</div>

	<div id="graf_sat" class="span12" style="height: 450px; margin-top:30px !important; margin-bottom:30px; margin-left: -5px;">
