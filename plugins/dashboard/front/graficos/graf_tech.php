...
<div id='content' >
<div id='container-fluid' style="margin: 0px 3% 0px 3%;">

<div id="pad-wrapper" >
<div id="charts" class="row-fluid chart">
<div id="head" class="row-fluid">

<a href="../index.php"><i class="fa fa-home" style="font-size:14pt; margin-left:6%;"></i><span></span></a>
...
echo '<div id="name"  style="margin-top: 15px;"><span>'.$tec_name['name'].' '.$tec_name['sname'].'</span> - <span style = "color:#000;"> '.$total_cham['total'].' '.__('Tickets','dashboard').'</span></div>
...
<script type="text/javascript" >
	...
	<div id="graf_time1" class="span12" style="height: 450px; margin-top:30px; margin-bottom:20px; margin-left: -5px;">
		<?php  include ("./inc/grafpie_time_tech.inc.php"); ?>
	</div>

	<div id="graf_sat" class="span12" style="height: 450px; margin-top:20px !important; margin-bottom:30px; margin-left: -5px;">
