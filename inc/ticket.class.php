...
//          $toadd['_no_notif'] = true;
   ...
   **/
   static function getTypes() {
      ...
      $options[self::INCIDENT_TYPE] = __('Falha');
      $options[self::DEMAND_TYPE]   = __('Solicitação');
   ...
   **/
   static function getAllStatusArray($withmetaforsearch=false) {
      ...
      $tab = array(self::INCOMING => _x('status', 'New'),
                   self::ASSIGNED => _x('status', 'Em Fila'),
                   self::PLANNED  => _x('status', 'Em Atendimento'),
                   self::WAITING  => __('Aguardando'),
